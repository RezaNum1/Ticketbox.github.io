...
<link rel="stylesheet" type="text/css" href="{{asset('assets/styles/image.css')}}">
<link href="{{asset('https://fonts.googleapis.com/css?family=Ultra&display=swap')}}" rel="stylesheet">
