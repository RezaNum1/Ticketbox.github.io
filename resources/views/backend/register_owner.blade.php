    ...
    <div class="row justify-content-center">
        <div class="bil" style="position: relative; top:150px; width: 600px;height: 550px;margin-bottom: 400px;">
            <div class="text-center" style="font-size: 40px;color: tomato; font-family: 'Ultra', serif;">Register
                <label style="color: black;">Take-In</label>&nbsp<label style="color: tomato;">Owner</label>
            </div>
            <form action="{{route('auth.register_ownerPro')}}" autocomplete="off" class="checkout_form" method="post">
                {{csrf_field()}}
