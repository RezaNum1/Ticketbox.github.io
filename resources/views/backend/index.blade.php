...
{{--        <img src="{{asset('assets/images/bg3.jpg')}}" style="width: 1500px; height: 800px; position: relative; bottom: 20px;">--}}
        ...
        <div class="caption">
            <form action="{{route('Base.search')}}" method="GET" class="menu_search_form" style="margin:0 auto;position: relative; bottom: 150px;">
                <label style="font-size: 40px;color: tomato; font-family: 'Ultra', serif;" class="row justify-content-center">Find Your Event</label>
                    <input type="text" name="builds"  class="search_input" placeholder="Find Your Event By Name and Location" required="required" value="{{ old('builds') }}" style="width: 20cm;margin: 0 auto">
                                        ...
                                        <div class="product_info d-flex flex-row align-items-start justify-content-start" style="height: auto">
                                            <div style="position: relative;">
                                                ...
                                                <a style="font-size: 20px;font-weight: bolder;">
                                                    ...
                                                    <div> <img src="{{asset('assets/images/clock.png')}}" style="width: 15px; height: 15px;margin-bottom: 5px;margin-right: 5px;">{{$build->time}}</a></div></div></div>
                                            </div>
                                        </div>
